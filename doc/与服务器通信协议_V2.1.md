...
schedule为日程格式(也可以当成留言文字)：time:日期(06/10)+时间(12:00) content:内容(xxx)
...
code：
	当type=bootload/app时,code为crc32校验码："04C11DB7",此时有版本信息
	当type=ziku时,code为哪个字库：ZK5X7_1/ZK5X7_2/ZKSYMB_1/ZKSYMB_2/ZKSYMB_U/ZK7X14_1/ZK7X14_2
	当type=wav时,code为哪个音频: SCLK00-SCLK23/SSYS00-SSYS15  UCLK00-UCLK23/USYS00-USYS15
	当type=voice,code为时间信息月日时分[09300800]: 默认存储用户7个留言信息，循环缓冲，如果用户没有听到，在触控下后，按顺序播放。	
...
{"message":{"command":"get_weather"}}
{"message":{"command":"get_clock"}}
{"message":{"update":{"ziku":"ZK5X7_1"}}}
{"message":{"version":[1,1]}}
{"message":{"transfer":0}}

{"message":{"command":"get_weather","update":"ZK5X7_1","version":[1,1],"transfer":0}}
{"message":{"command":"get_weather","update":"ZK5X7_1","version":[1,1],"transfer":0}}
{"message":{"command":"get_weather","update":"ZK5X7_1","version":[1,1],"transfer":0}}
